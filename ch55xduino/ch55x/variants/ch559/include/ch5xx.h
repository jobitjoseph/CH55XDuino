...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x2448) uint8_t UEP0_DMA_H;	// endpoint 0&4 buffer start address high byte
volatile __xdata __at(0x2449) uint8_t UEP0_DMA_L;	// endpoint 0&4 buffer start address low byte
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x244A) uint8_t UEP1_DMA_H;	// endpoint 1 buffer start address high byte
volatile __xdata __at(0x244B) uint8_t UEP1_DMA_L;	// endpoint 1 buffer start address low byte
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x244C) uint8_t UEP2_DMA_H;	// endpoint 2 buffer start address high byte
volatile __xdata __at(0x244D) uint8_t UEP2_DMA_L;	// endpoint 2 buffer start address low byte
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x244E) uint8_t UEP3_DMA_H;	// endpoint 3 buffer start address high byte
volatile __xdata __at(0x244F) uint8_t UEP3_DMA_L;	// endpoint 3 buffer start address low byte
...
//volatile __xdata __at(0x244C) uint8_t UH_RX_DMA_H;	// host rx endpoint buffer start address high byte
#define UH_RX_DMA_H       UEP2_DMA_H
#define pUH_RX_DMA_H     pUEP2_DMA_H
//volatile __xdata __at(0x244D) uint8_t UH_RX_DMA_L;	// host rx endpoint buffer start address low byte
...
//volatile __xdata __at(0x244E) uint8_t UH_TX_DMA_H;	// host rx endpoint buffer start address high byte
#define UH_TX_DMA_H       UEP3_DMA_H
#define pUH_TX_DMA_H     pUEP3_DMA_H
//volatile __xdata __at(0x244F) uint8_t UH_TX_DMA_L;	// host rx endpoint buffer start address low byte
...
#endif
//volatile __xdata __at(0x2882) uint8_t LED_FIFO_CN;	// ReadOnly: FIFO count status
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x2884) uint8_t LED_DMA_AH;	// DMA address high byte, automatic increasing after DMA
volatile __xdata __at(0x2885) uint8_t LED_DMA_AL;	// DMA address low byte, automatic increasing after DMA
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x2886) uint8_t LED_DMA_CN;	// DMA remainder word count, just main buffer and exclude aux buffer, automatic decreasing after DMA
...
#ifndef NO_XSFR_DEFINE
volatile __xdata __at(0x2888) uint8_t LED_DMA_XH;	// aux buffer DMA address high byte, automatic increasing after DMA
volatile __xdata __at(0x2889) uint8_t LED_DMA_XL;	// aux buffer DMA address low byte, automatic increasing after DMA
